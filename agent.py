...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=True, epsilon=1.0, alpha=0.95):
		...
		#self.maxQ = maxQ
        self.t = 0
        self.a = 0.999 #0.99 # a for decaying function
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing == True:
            ...
            #self.epsilon = self.epsilon - math.exp((-1)*self.a* self.t)
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning == True:
            ...
            Q_actual = self.Q[state][action]
            self.Q[state][action] = reward*self.alpha + Q_actual*(1-self.alpha)
